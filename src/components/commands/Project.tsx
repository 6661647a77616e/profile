	...
	return (
		<div>
			...
			<p className="text-lg mb-3 animate-reveal-0.5">
				...
				through the portfolio in the terminal way. I forked it from <a href="https://github.com/Chensokheng/terminal-portfolio">Chensokheng</a> and modified it into my own
			</p>
			...
			<p className="text-lg animate-reveal-0.7">
				...
				deployment, I deploy it on Vercel.
			</p>
